...
/*
 * An authentication token addressed to a specific AuthenticationProvider
 */

public class ProviderWrappedAuthenticationToken implements Authentication, CredentialsContainer {

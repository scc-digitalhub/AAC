...
public abstract class AbstractInternalResourceProvider<
    R extends AbstractInternalApiResource<S, D>,
    S extends AbstractInternalApiScope,
    D extends AbstractClaimDefinition,
    C extends AbstractApiResourceProviderConfig<R, InternalApiResourceProviderConfigMap>
>
    ...
    protected AbstractClaimsSetExtractor buildClaimsExtractor(R resource) {
        ...
        return new NullClaimsSetExtractor(

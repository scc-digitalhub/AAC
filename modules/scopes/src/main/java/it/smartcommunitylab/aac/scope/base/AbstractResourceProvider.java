...
import it.smartcommunitylab.aac.scope.provider.ConfigurableApiResourceProvider;
import org.springframework.util.Assert;

public abstract class AbstractResourceProvider<
    R extends AbstractApiResource<S>,
    S extends AbstractApiScope,
    M extends AbstractConfigMap,
    C extends AbstractApiResourceProviderConfig<R, M>
>
    ...
    @Override
    public abstract ApiScopeProvider<S> getScopeProvider(String scope) throws NoSuchScopeException;

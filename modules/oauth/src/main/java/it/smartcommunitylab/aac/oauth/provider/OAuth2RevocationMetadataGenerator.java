...
/*
 * OAuth2 Token Revocation Metadata
 * https://datatracker.ietf.org/doc/html/rfc7009
 * https://datatracker.ietf.org/doc/html/rfc8414
 */
@Component
public class OAuth2RevocationMetadataGenerator implements OAuth2MetadataGenerator {
    ...
    public Map<String, Object> generate() {
        //@formatter:off
        /**
         * extend metadata for oauth2 for token revocation
         * 
            revocation_endpoint 
        ...
        map.put("revocation_endpoint", baseUrl + TokenRevocationEndpoint.TOKEN_REVOCATION_URL);
        map.put("revocation_endpoint_auth_methods_supported", authMethods);
        map.put("revocation_endpoint_auth_signing_alg_values_supported", authSigninAlgorithms);

...
import it.smartcommunitylab.aac.credentials.persistence.UserCredentialsStore;
...
public abstract class AbstractUserCredentialsProvider<
...
>
    extends AbstractConfigurableResourceProvider<R, C, UserCredentialsProviderSettingsMap, M>
    implements UserCredentialsProvider<R, E, M, C>, InitializingBean {
    ...
    // services
    protected final UserCredentialsStore<R> credentialsService;
    ...
    protected AbstractUserCredentialsProvider(
        String authority,
        String providerId,
        UserCredentialsStore<R> credentialsService,
        C providerConfig,
        String realm
    ) {

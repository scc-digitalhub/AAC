...
public abstract class AbstractUserAttributes extends AbstractBaseUserResource implements UserAttributes {

    protected AbstractUserAttributes(String authority, String provider, String realm) {
        super(authority, provider, realm, null, null);
    }

    protected AbstractUserAttributes(String authority, String provider, String realm, String userId) {

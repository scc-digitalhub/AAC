...
import it.smartcommunitylab.aac.auth.model.RealmWrappedAuthenticationToken;
import it.smartcommunitylab.aac.auth.model.WebAuthenticationDetails;
import it.smartcommunitylab.aac.auth.model.WrappedAuthenticationToken;
...
public class ExtendedUserAuthenticationManager implements AuthenticationManager {
    ...
    protected UserAuthentication attempAuthenticate(
        ...
        ExtendedUserAuthenticationProvider<? extends UserAuthenticatedPrincipal, ? extends UserAccount> provider

...
import it.smartcommunitylab.aac.attributes.UserAttributeProviderAuthority;
...
public abstract class AbstractUserAttributeAuthority<
    S extends AbstractUserAttributeProvider<? extends AbstractUserAttributes, C, M>,
    M extends AbstractConfigMap,
    C extends AbstractUserAttributeProviderConfig<M>
>
    extends AbstractConfigurableProviderAuthority<S, C, AttributeProviderSettingsMap, M>
    implements UserAttributeProviderAuthority<S, C, M> {
    ...
    protected AbstractUserAttributeAuthority(
        String authorityId,

...
public abstract class AbstractUserCredentialsProviderConfig<M extends AbstractConfigMap>
    extends AbstractProviderConfig<UserCredentialsProviderSettingsMap, M>
    implements UserCredentialsProviderConfig<M> {

    private static final long serialVersionUID = SystemKeys.AAC_CORE_SERIAL_VERSION;

    protected AbstractUserCredentialsProviderConfig(
        String authority,
        String provider,
        String realm,
        UserCredentialsProviderSettingsMap settingsMap,
        M configMap
    ) {
    ...
    protected AbstractUserCredentialsProviderConfig(
        ConfigurableUserCredentialsProvider cp,
        UserCredentialsProviderSettingsMap settingsMap,
        M configMap
    ) {

...
@Transactional
public abstract class AbstractUserAttributeProvider<
    U extends AbstractUserAttributes, C extends AbstractUserAttributeProviderConfig<M>, M extends AbstractConfigMap
>
    ...
    protected AbstractUserAttributeProvider(
        String authority,
        String providerId,

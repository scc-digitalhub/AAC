...
public class OpenIdFedAccountServiceConfig extends AbstractAccountServiceConfig<OpenIdFedIdentityProviderConfigMap> {
    ...
    public OpenIdFedAccountServiceConfig(String provider, String realm) {
        this(SystemKeys.AUTHORITY_OPENIDFED, provider, realm);
    }

    public OpenIdFedAccountServiceConfig(String authority, String provider, String realm) {
        super(authority, provider, realm, new AccountServiceSettingsMap(), new OpenIdFedIdentityProviderConfigMap());
    }

    public OpenIdFedAccountServiceConfig(
    ...
    private OpenIdFedAccountServiceConfig() {
        super();
    }

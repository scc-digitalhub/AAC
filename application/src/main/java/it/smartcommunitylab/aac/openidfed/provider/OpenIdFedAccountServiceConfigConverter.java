...
public class OpenIdFedAccountServiceConfigConverter
    implements Converter<OpenIdFedIdentityProviderConfig, OpenIdFedAccountServiceConfig> {

    @Override
    public OpenIdFedAccountServiceConfig convert(OpenIdFedIdentityProviderConfig source) {
        OpenIdFedAccountServiceConfig config = new OpenIdFedAccountServiceConfig(
            source.getProvider(),
            source.getRealm()
        );

    ...
    public Collection<UserAttributes> convertPrincipalAttributes(
        ...
        try {
            ...
            if (!response.getStatusCode().is2xxSuccessful()) {
                throw new IllegalArgumentException("invalid response from webhook");
            }
            ...
            throw new IllegalArgumentException("Invalid hook URL " + String.valueOf(configMap.getUrl()));
        } catch (Exception e) {
            throw new IllegalArgumentException("Hook invocation failure: " + e.getMessage());
        }

...
public class PasswordHash {
    ...
    public PasswordHash() {
        this(PBKDF2_ALGORITHM, HASH_BYTE_SIZE, PBKDF2_ITERATIONS);
    }

    public PasswordHash(String algorithm, int hashSize, int iterations) {
        Assert.notNull(algorithm, "pbkdf2 algorithm can not be null");
        this.algorithm = algorithm;
        this.hashSize = hashSize;
        this.saltSize = SALT_BYTE_SIZE;
    ...
    public String createHash(String passwordString)
        ...
        // Hash the password
        byte[] hash = pbkdf2(password, algorithm, salt, iterations, hashSize);
    ...
    public boolean validatePassword(String passwordString, String correctHash)
        ...
        byte[] testHash = pbkdf2(password, algorithm, salt, iterations, hash.length);

...
public class GroupManager {
    ...
    public Collection<Group> getGroups(String realm) throws NoSuchRealmException {
    ...
    public Group updateGroup(String realm, String groupId, Group g) throws NoSuchRealmException, NoSuchGroupException {
    ...
    public Collection<String> addGroupMembers(String realm, String group, Collection<String> subjects)
        ...
        subjects.stream().map(s -> groupService.addGroupMember(realm, group, s)).collect(Collectors.toList());
    ...
    public Collection<String> removeGroupMembers(String realm, String group, Collection<String> subjects)
        throws NoSuchRealmException, NoSuchGroupException {
        subjects.stream().forEach(s -> groupService.removeGroupMember(realm, group, s));

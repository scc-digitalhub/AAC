...
public interface ClaimsExtractor<C extends Claim> {
    ...
    Collection<C> extractUserClaims(User user, ClientDetails client, Collection<String> scopes,
            Map<String, Serializable> extensions);

    Collection<C> extractClientClaims(ClientDetails client, Collection<String> scopes,
            Map<String, Serializable> extensions);

...
public class BaseServicesController implements InitializingBean {
    ...
    public Service addService(
        ...
        logger.debug("add service for realm {}", StringUtils.trimAllWhitespace(realm));
    ...
    public Collection<Approval> getRealmServiceApprovals(
        ...
        logger.debug(
            "get approvals for service {} for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public Collection<ServiceScope> listServiceScopes(
        ...
        logger.debug(
            "list scopes from service {} for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public ServiceScope addServiceScope(
        ...
        logger.debug(
            "add scope to service {} for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public ServiceScope getServiceScope(
        ...
        logger.debug(
            "get scope {} from service {} for realm {}",
    ...
    public ServiceScope updateServiceScope(
        ...
        logger.debug(
            "update scope {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(scope),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public void deleteServiceScope(
        ...
        logger.debug(
            "delete scope {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(scope),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public Collection<ServiceClaim> listServiceClaims(
        ...
        logger.debug(
            "list claims from service {} for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public ServiceClaim addServiceClaim(
        ...
        logger.debug(
            "add claim to service {} for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public ServiceClaim getServiceClaim(
        ...
        logger.debug(
            "get claim {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(key),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public ServiceClaim updateServiceClaim(
        ...
        logger.debug(
            "update claim {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(key),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public void deleteServiceClaim(
        ...
        logger.debug(
            "delete claim {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(key),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public Collection<Approval> getServiceScopeApprovals(
        ...
        logger.debug(
            "list approvals from service {}for realm {}",
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)
        );
    ...
    public Approval addServiceScopeApproval(
        ...
        logger.debug(
            "add approval for scope {} client {} to service {} for realm {}",
            StringUtils.trimAllWhitespace(scope),
    ...
    public void deleteServiceScopeApproval(
        ...
        logger.debug(
            "revoke approval for scope {} client {} from service {} for realm {}",
            StringUtils.trimAllWhitespace(scope),
            StringUtils.trimAllWhitespace(clientId),
            StringUtils.trimAllWhitespace(serviceId),
            StringUtils.trimAllWhitespace(realm)

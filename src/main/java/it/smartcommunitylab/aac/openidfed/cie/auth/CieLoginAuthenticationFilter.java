 ...
 */
public class CieLoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

    private final Logger logger = LoggerFactory.getLogger(getClass());

    public static final String DEFAULT_FILTER_URI = CieIdentityAuthority.AUTHORITY_URL + "login/{providerId}";
    ...
    public CieLoginAuthenticationFilter(ProviderConfigRepository<CieIdentityProviderConfig> registrationRepository) {
        this(SystemKeys.AUTHORITY_CIE, registrationRepository, DEFAULT_FILTER_URI, null);
    }

    public CieLoginAuthenticationFilter(
        String authority,
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        CieIdentityProviderConfig providerConfig = registrationRepository.findByProviderId(providerId);

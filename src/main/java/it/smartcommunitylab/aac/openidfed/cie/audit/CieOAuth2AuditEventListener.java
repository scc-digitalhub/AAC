...
import it.smartcommunitylab.aac.openidfed.audit.OAuth2UserRequestMixins;
...
@Component
public class CieOAuth2AuditEventListener
    ...
    public void onApplicationEvent(OAuth2MessageEvent event) {
        ...
        logger.debug("receive cie message event for {}:{} key {}", authority, provider, String.valueOf(tx));

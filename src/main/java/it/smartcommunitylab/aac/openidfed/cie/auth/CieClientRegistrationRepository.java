...
public class CieClientRegistrationRepository implements ClientRegistrationRepository {

    //config
    private final CieIdentityProviderConfigMap configMap;
    ...
    public CieClientRegistrationRepository(

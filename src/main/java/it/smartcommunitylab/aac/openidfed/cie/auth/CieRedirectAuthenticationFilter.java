...
import it.smartcommunitylab.aac.openidfed.cie.CieIdentityAuthority;
...
public class CieRedirectAuthenticationFilter extends OncePerRequestFilter implements ApplicationEventPublisherAware {

    private final Logger logger = LoggerFactory.getLogger(getClass());

    public static final String DEFAULT_FILTER_URI = CieIdentityAuthority.AUTHORITY_URL + "authorize/{providerId}";
    ...
    public CieRedirectAuthenticationFilter(ProviderConfigRepository<CieIdentityProviderConfig> registrationRepository) {
        this(SystemKeys.AUTHORITY_CIE, registrationRepository, DEFAULT_FILTER_URI);
    }

    public CieRedirectAuthenticationFilter(
        String authority,
        ...
        this.authorizationRequestResolver =
            new CieOAuth2AuthorizationRequestResolver(registrationRepository, filterProcessingUrl);

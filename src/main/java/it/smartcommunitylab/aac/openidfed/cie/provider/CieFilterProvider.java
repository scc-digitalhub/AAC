...
import it.smartcommunitylab.aac.openidfed.cie.auth.CieLoginAuthenticationFilter;
import it.smartcommunitylab.aac.openidfed.cie.auth.CieMetadataFilter;
import it.smartcommunitylab.aac.openidfed.cie.auth.CieRedirectAuthenticationFilter;
import it.smartcommunitylab.aac.openidfed.cie.auth.CieResolverFilter;
...
public class CieFilterProvider implements FilterProvider, ApplicationEventPublisherAware {
    ...
    public CieFilterProvider(ProviderConfigRepository<CieIdentityProviderConfig> registrationRepository) {
        this(SystemKeys.AUTHORITY_CIE, registrationRepository);
    }

    public CieFilterProvider(
        String authorityId,
    ...
    public List<Filter> getAuthFilters() {
        ...
        CieMetadataFilter metadataFilter = new CieMetadataFilter(
            authorityId,
        ...
        CieResolverFilter resolveFilter = new CieResolverFilter(
            authorityId,
            registrationRepository,
            buildFilterUrl("resolve/{providerId}")
        );

        CieRedirectAuthenticationFilter redirectFilter = new CieRedirectAuthenticationFilter(
            authorityId,
            registrationRepository,
        ...
        CieLoginAuthenticationFilter loginFilter = new CieLoginAuthenticationFilter(
            authorityId,
            registrationRepository,

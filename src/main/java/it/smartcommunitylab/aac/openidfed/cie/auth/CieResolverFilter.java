...
import it.smartcommunitylab.aac.openidfed.auth.OpenIdFedErrorHttpMessageHandler;
...
public class CieResolverFilter extends OncePerRequestFilter {
    ...
    public static final String DEFAULT_FILTER_URI = CieIdentityAuthority.AUTHORITY_URL + "resolve/{providerId}";
    ...
    public CieResolverFilter(ProviderConfigRepository<CieIdentityProviderConfig> registrationRepository) {
        this(SystemKeys.AUTHORITY_CIE, registrationRepository, DEFAULT_FILTER_URI);
    }

    public CieResolverFilter(
        String authority,

...
public class CieAccountServiceConfigConverter
    implements Converter<CieIdentityProviderConfig, CieAccountServiceConfig> {

    @Override
    public CieAccountServiceConfig convert(CieIdentityProviderConfig source) {
        CieAccountServiceConfig config = new CieAccountServiceConfig(
            source.getProvider(),
            source.getRealm()
        );

...
public class CieMetadataFilter extends OncePerRequestFilter {
    ...
    public static final String DEFAULT_FILTER_URI = CieIdentityAuthority.AUTHORITY_URL + "metadata/{providerId}";
    ...
    public CieMetadataFilter(ProviderConfigRepository<CieIdentityProviderConfig> registrationRepository) {
        this(SystemKeys.AUTHORITY_CIE, registrationRepository, DEFAULT_FILTER_URI);
    }

    public CieMetadataFilter(
        String authority,
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        try {
            String metadata = metadataResolver.resolveEntityMetadata(
                config.toOpenIdFedIdentityProviderConfig(),
                request
            );

...
public class JwtHttpMessageConverter extends AbstractHttpMessageConverter<Map<String, Object>> {

    private final NimbusJwtDecoder decoder;

    public JwtHttpMessageConverter(String jwksUri) {
    ...
    public JwtHttpMessageConverter(String jwksUri, JWK jweKey, String jweAlgorithm, String jweMethod) {
        super(new MediaType("application", "jwt"), new MediaType("application", "jose"));
    ...
    @Override
    protected void writeInternal(Map<String, Object> t, HttpOutputMessage outputMessage)

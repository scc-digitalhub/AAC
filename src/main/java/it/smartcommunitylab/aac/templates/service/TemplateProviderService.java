...
public class TemplateProviderService
    extends AbstractConfigurableProviderService<ConfigurableTemplateProvider, TemplateProviderSettingsMap> {
    ...
    public TemplateProviderService(
        ...
        super(SystemKeys.RESOURCE_TEMPLATE, authorityService, providerService, ConfigurableTemplateProvider::new);
        //     // set converters

...
public class SamlAccountServiceAuthority
        extends
        AbstractConfigurableProviderAuthority<SamlAccountService, SamlUserAccount, ConfigurableAccountProvider, SamlIdentityProviderConfigMap, SamlAccountServiceConfig>
        implements

...
import it.smartcommunitylab.aac.clients.persistence.ClientEntityRepository;
...
public class ClientEntityService {
    ...
    public ClientEntityService(ClientEntityRepository clientRepository, SubjectService subjectService) {
    ...
    public ClientEntity addClient(
        ...
        // cleanup maps
        Map<String, String> hFunctions = hookFunctions == null
            ? null
            : hookFunctions
                .entrySet()
                .stream()
        ...
        Map<String, String> hWebUrls = hookWebUrls == null
            ? null
            : hookWebUrls
                .entrySet()
                .stream()
    ...
    public Page<ClientEntity> searchClients(String realm, String q, Pageable pageRequest) {
        Page<ClientEntity> page = StringUtils.hasText(q)
            ? clientRepository.findByRealmAndNameContainingIgnoreCaseOrRealmAndClientIdContainingIgnoreCase(
                realm,
                q,
                realm,
                q,

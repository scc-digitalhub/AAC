...
public enum AuthenticationMethod {
    ...
    /**
     * Clients that have received a client secret from the authorisation server
     * authenticate with the authorisation server in accordance with section 3.2.1
    ...
    /**
     * Client authentication by means of a request object at the authorisation or

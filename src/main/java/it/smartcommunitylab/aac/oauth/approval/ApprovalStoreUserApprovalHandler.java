    ...
    public AuthorizationRequest checkForPreApproval(AuthorizationRequest request,
        ...
        if (autoApprovedScopes.containsAll(requestedScopes)) {
            ...
            for (String scope : autoApprovedScopes) {
                Approval approval = new Approval(subjectId, clientId,
                        scope, expiresAt, ApprovalStatus.APPROVED);
...
//        }
    ...
    private AuthorizationRequest updateScopeApprovals(AuthorizationRequest authorizationRequest,
        ...
        boolean userApproved = !approvalParameters.containsKey(OAuth2Utils.USER_OAUTH_APPROVAL)
    ...
    private Set<String> getAutoApproved(
        ...
        if (scopeRegistry != null) {
            ...
            if (clientDetails.isFirstParty()
                ...
                autoApprovedScopes = requestedScopes.stream()

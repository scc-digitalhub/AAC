...
public class RolesClaimsSetExtractor extends AbstractResourceClaimsSetExtractor<RolesResource> {

    public RolesClaimsSetExtractor(RolesResource resource) {
        super(resource);
        this.claimsExtractor = new RolesClaimsExtractor();
    }

    public static class RolesClaimsExtractor implements ClaimsExtractor<AbstractClaim> {

        @Override
        public List<AbstractClaim> extractUserClaims(User user, ClientDetails client, Collection<String> scopes,
        ...
        @Override
        public List<AbstractClaim> extractClientClaims(ClientDetails client, Collection<String> scopes,
                Map<String, Serializable> extensions) {

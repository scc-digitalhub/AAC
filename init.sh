...
cp /home/aac/config/application-local.yml /home/aac/application-local.yml
java -XX:MaxRAMFraction=2 -jar -Dspring.config.location=/home/aac/application-local.yml -Dspring.profiles.active=local,authorization aac.jar
